...
class CfgUnitInsignia {
 ...
 class 9Jgkp_Insignia_MrBlue: 9JgKp_Insignia_Logo
    {
      displayName = "9. JgKp Mr. Blue";
      texture = "\9JgKp_Insignia_Player\Player\Bilder\MrBlue.paa";
	  author="Nilia";
  };
 ...
 class 9Jgkp_Insignia_Tom: 9JgKp_Insignia_Logo
    {
      displayName = "9. JgKp Tom";
      texture = "\9JgKp_Insignia_Player\Player\Bilder\Tom.paa";
	  author="Nilia";
  };
